...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [253055.900412, 199813.431000, 344611.629588, 243863.829000], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:27700',
...
map.getView().fit([253055.900412, 199813.431000, 344611.629588, 243863.829000], map.getSize());

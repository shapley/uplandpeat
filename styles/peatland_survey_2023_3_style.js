var size = 0;
var placement = 'point';
function categories_peatland_survey_2023_3(feature, value, size, resolution, labelText,
...
var style_peatland_survey_2023_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_peatland_survey_2023_3(feature, value, size, resolution, labelText,

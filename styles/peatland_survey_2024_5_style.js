var size = 0;
var placement = 'point';
function categories_peatland_survey_2024_5(feature, value, size, resolution, labelText,
...
var style_peatland_survey_2024_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_peatland_survey_2024_5(feature, value, size, resolution, labelText,

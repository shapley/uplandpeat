var size = 0;
var placement = 'point';
function categories_peatland_survey_2024_4(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'No Peat':
...
var style_peatland_survey_2024_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Colour Code:");
    ...
    var style = categories_peatland_survey_2024_4(feature, value, size, resolution, labelText,
